for(i=0;i<global.life;i++){												// loop through the number of hearts we have
...
draw_text(view_wport[0]-20-sprite_get_width(sPickupStar),57,global.puntaje);	// draw the number of stars collected
